...
# ---------------------------------------------------------
# 1. 경로 설정 (Level01/P90 폴더 생성)
# ---------------------------------------------------------
current_dir = os.path.dirname(os.path.abspath(__file__))
root_dir = os.path.abspath(os.path.join(current_dir, "..", ".."))
base_dir = os.path.join(root_dir, "Level01", "P90")
...
# ---------------------------------------------------------
# 5. 테스트케이스 생성 (20개)
#    - 내부 채점 속도를 위해 n,m은 작게(<=300) 생성
#    - 문제 제한은 더 크지만, 로직 검증용으로 충분
# ---------------------------------------------------------
random.seed(90)
...
print("✅ 'Level01/P90' 문제 생성이 완료되었습니다.")

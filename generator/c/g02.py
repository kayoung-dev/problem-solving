...
# 생성기 위치 기준 상위 폴더들을 거슬러 올라가 'C' 폴더 위치 설정
root_dir = os.path.abspath(os.path.join(current_dir, "..", "..")) 
base_dir = os.path.join(root_dir, "C", "P02")
...
# 2. 문제 설명 (problem.md)
# ---------------------------------------------------------
# 수정 1: '지수' 이름의 굵게 표시(**) 제거
# 수정 2: 예시 2번에 대한 상세 설명 텍스트 추가
# 주의: f-string 안에서 중괄호 {}를 문자로 쓰려면 {{ }}로 두 번 써야 합니다.
md_content = f"""# 인터넷 브라우저의 '뒤로 가기' (Browser Back Button)

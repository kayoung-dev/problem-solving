...
base_dir = os.path.join(root_dir, "Level00", "P016")
...
- 이동을 적용한 결과가 1층 미만이면 **1층으로 고정**, 50층 초과이면 **50층으로 고정**합니다.
모든 기록을 처리한 뒤 **최종 층**을 출력하세요.

## input_description
- 한 줄에 기록들이 공백으로 구분되어 주어집니다.
- 기록의 개수는 1개 이상입니다.
- 각 기록은 `Uk` 또는 `Dk` 형태입니다. ($k$는 $0$ 이상 $50$ 이하의 정수입니다.)
...
print("✅ 'Level00/P016' 생성이 완료되었습니다.")
